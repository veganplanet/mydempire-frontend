(function () {
  const ACTIVITY_SOURCES = [
    ...
    ["Crate Open", "2 AP/crate • Max 8/day"],
    ["Local Empire Operation", "1 AP"],
    ["Regional Empire Operation", "3 AP"],
    ["Imperial Empire Operation", "8 AP"],
    ["Standard Fulfillment", "1 AP"],
    ["Bulk Fulfillment", "2 AP"],
    ["Grand Fulfillment", "4 AP"],
    ["Rat Cleanup up to Orderly", "3 AP"],
    ["Rat Cleanup Cluttered / Infested", "5 AP"],
    ["Hire Manager", "10 AP"],
    ["Accept Management Deal", "15 AP"],
    ["Foundry Craft", "25 AP"],
    ["Claim Daily Goods", "1 AP/day"],
    ["Redeem Goods", "1 AP/day"],
  ];
